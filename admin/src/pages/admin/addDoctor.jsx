...
export default function AddDoctor() {
  ...
  return (
    <>
      <form
        className="w-full mt-5 px-8 flex flex-col gap-4"
        ...
        <div className="bg-white px-8 py-8 border border-gray-400 rounded-md shadow-lg space-y-4">
            ...
            <div className="w-full lg:flex-1 flex flex-col gap-4">
              <div className="flex-1 flex flex-col gap-1">
                ...
                <input
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-md outline-0"
                  type="text"
                  placeholder="name"
                  required
                />
              ...
              <div className="flex-1 flex flex-col gap-1">
                ...
                <select
                  ...
                  className="border border-gray-300 px-3 py-2 rounded-md outline-0"
                >
          ...
          <div className="text-gray-500 mt-6 mb-2">
            ...
            <textarea
              ...
              className="px-4 py-2 border border-gray-300 w-full outline-0 rounded-md"
          ...
          <button className="bg-main mt-6 cursor-pointer px-10 py-2 text-white font-medium rounded-full capitalize">
            add doctor
          </button>
        </div>
      </form>
