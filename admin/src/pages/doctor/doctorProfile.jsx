...
export default function DoctorProfile() {
  const { docProfile, setDocProfile, dToken, getDoctorProfile, backend_url } =
        ...
        <div>
          {docProfile && (
            <div className="flex flex-col gap-4 m-5">
              <div>
                <img
                  className="bg-main/80 w-full sm:max-w-64 rounded-lg"
              ...
              <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-gray-100">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 mt-1 text-gray-600">
                  ...
                  <button className="border-1 border-gray-600 px-2 rounded-full text-sm">
                ...
                <p className="text-gray-600 font-medium mt-4">
                  ...
                  {isEdit ? (
                    <input
                      className="px-2 py-1 rounded-md border-1 border-gray-300 outline-0"
                      type="number"
                      onChange={(e) => {
                        setDocProfile((prev) => ({
                          ...prev,
                ...
                <div className="flex flex-col sm:flex-row gap-2 py-2">
                  ...
                  <p className="text-sm">
                    ...
                    {isEdit ? (
                      <input
                        className="px-2 py-1 rounded-md border-1 border-gray-300 mt-3 outline-0"
                        type="text"
                        onChange={(e) =>
                          setDocProfile((prev) => ({
                            ...prev,
                ...
                {isEdit ? (
                  <button
                    ...
                    className="px-4 py-1 border border-main text-sm rounded-full mt-5 cursor-pointer hover:bg-main hover:text-white transition-all duration-300 capitalize"
                  >
                    save informations
                  </button>
                ) : (
