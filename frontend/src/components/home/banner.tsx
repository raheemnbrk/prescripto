    ...
    <>
      <div className="bg-primary rounded-md flex gap-8 px-16 py-8 md:py-0">
        <div className="flex flex-col space-y-4 md:pt-16">
          ...
          <button className="text-gray-600 bg-stone-100 rounded-full px-8 py-3 font-semibold hover:scale-105 transition-all duration-300 cursor-pointer w-fit md:mt-8 cursor-pointer">
