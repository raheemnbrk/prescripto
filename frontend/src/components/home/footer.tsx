      ...
      <div className="mt-24 px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-36 py-8 border-b border-gray-400">
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-gray-600">
              ...
              totam quaerat provident fuga officia sit aperiam, minima
              voluptatem repudiandae ipsam iusto fugit eos dolor qui illo
              voluptatum tempore tenetur hic?
            </p>
          </div>
        ...
        <div className="p-6 text-center">
          <p className="font-medium text-sm">
            Copyrights {time} @raheemnbrk-All rights reserved{" "}
          </p>
        </div>
      </div>
    </>
