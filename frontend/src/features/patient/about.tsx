        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="flex flex-col space-y-6 border border-gray-200 px-12 py-16 hover:bg-primary transition-all duration-200 group cursor-pointer">
            ...
            <p className="text-gray-500 font-light group-hover:text-white">
              Streamlined appointment <br /> scheduling that fits into your{" "}
              <br /> busy lifestyle.
            </p>
          </div>
          <div className="flex flex-col space-y-6 border border-gray-200 px-12 py-16 hover:bg-primary transition-all duration-200 group cursor-pointer">
            ...
            <p className="text-gray-500 font-light group-hover:text-white">
              Access to a network of <br /> trusted healthcare professionals{" "}
              <br /> in your area.
            </p>
          </div>
          <div className="flex flex-col space-y-6 border border-gray-200 px-12 py-16 hover:bg-primary transition-all duration-200 group cursor-pointer">
            ...
            <p className="text-gray-500 font-light group-hover:text-white">
              Tailored recommendations <br /> and reminders to help you stay{" "}
              <br /> on top of your health.
            </p>
          </div>
        </div>
      </div>
